<template>
  ...
  <p class="text-gray-100 text-base md:text-lg leading-relaxed md:leading-snug">
  Sistem pajak daerah terpadu merupakan aplikasi berbasis mobile dan berbasis website 
  yang diperuntukkan bagi wajib pajak atau objek pajak agar memudahkan dalam pelaporan 
  jenis pajak daerah yang terdiri dari
  Pajak Hotel, Pajak Restoran, Pajak Parkir, Pajak Hiburan, Pajak Reklame, 
  Pajak Sarang Burung Walet, Pajak Penerangan, Pajak Air Tanah 
  dan Pajak Mineral Bukan Logam Batuan.
</p>
...
<section class="bg-gradient-to-b from-sky-50 to-white py-24" data-aos="fade-up">
  <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
    ...
    <div class="space-y-4 text-left">
      <h2 class="text-5xl font-bold text-[#005787]">Demo Aplikasi SIPPADU</h2>
...
<section class="bg-gradient-to-t from-sky-50 to-white py-24" data-aos="fade-up">
  <div class="max-w-7xl mx-auto px-6">
    ...
    <p class="text-gray-600 text-lg text-center mb-12">
      Berikut fitur yang terdapat pada aplikasi SIPPADU
    </p>
...
<div class="md:col-span-4 space-y-8">
  ...
  <li>Pendaftaran Wajib Pajak</li>
  <li>Pendataan SPTPD</li>
</ul>

<ul class="list-disc pl-6 space-y-2 text-gray-500 text-lg leading-relaxed">
  <li>Penetapan SSPD</li>
  <li>Penerimaan SSPD</li>
  <li>Penagihan STPD</li>
</ul>
...
const heroImage = new URL("@/assets/img/sippadu.png", import.meta.url).href;
...
/* === FITUR === */
const fitur = [
  "Pelaporan E-SPTPD melalui Website/Mobile",
  "Manajemen Pajak Daerah Self Assesment",
  "manajemen Pajak Daerah Official Assesment",
