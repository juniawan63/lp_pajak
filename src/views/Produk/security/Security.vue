        ...
        <div class="grid grid-cols-1 md:grid-cols-6 gap-12 items-start">
          ...
          <div class="md:col-span-4 space-y-8">
            ...
            <ul class="list-disc pl-6 space-y-2 text-gray-500 text-lg leading-relaxed">
                <li>Ringkasan status keamanan, ancaman aktif, dan audit log.</li>
                <li>Pengaturan level akses (Admin, Operator, Auditor, dll).</li>
                <li>Log aktivitas pengguna.</li>
              </ul>

              <ul class="list-disc pl-6 space-y-2 text-gray-500 text-lg leading-relaxed">
                <li>Rekam otomatis semua tindakan dalam sistem.</li>
                <li>Fitur pencarian dan filter log.</li>
                <li>Konfigurasi enkripsi komunikasi dan penyimpanan data.</li>
              </ul>

              <ul class="list-disc pl-6 space-y-2 text-gray-500 text-lg leading-relaxed">
                <li>Status validasi sertifikat keamanan.</li>
                <li>Ringkasan kesesuaian terhadap ISO/PDN.</li>
                <li>Dokumen audit dan laporan pemeriksaan.</li>
              </ul>
            </div>
          </div>
        </div>
