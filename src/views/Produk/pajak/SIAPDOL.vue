  ...
  >
    ...
    >
      ...
      >
        ...
        >
        Dashboard realisasi pajak daerah yang terintegrasi dengan semua jenis pajak daerah. Aplikasi ini sebagai gerabang satu pintu menuju beberapa pelayanan pajak daerah.
        </p>
        ...
        >
          <a
            href="https://wa.me/6282116081198?text=Halo,%20saya%20ingin%20menjadwalkan%20demo%20aplikasi%20SIAPDOL."
            target="_blank"
          ...
          <a
            href="https://wa.me/6282116081198?text=Halo,%20saya%20ingin%20konsultasi%20gratis%20terkait%20aplikasi%20SIAPDOL."
            target="_blank"
...
<section class="bg-gradient-to-b from-sky-50 to-white py-24" data-aos="fade-up">
  <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
    ...
    <div class="space-y-4 text-left">
      <h2 class="text-5xl font-bold text-[#005787]">Demo Aplikasi Sistem Pajak daerah Online</h2>
      <p class="text-[#005787] text-lg leading-relaxed">
     Aplikasi Pajak Daerah Online diperuntukan bagi BAPPENDA atau BAPEDA yang ingin mengintegrasikan semua sistem pajak daerah dalam satu pintu. Aplikasi ini mempermudah pengguna untuk melakukan pembayaran pajak daerah.
       </p>
    </div>
  </div>
</section>
...
<section class="bg-gradient-to-t from-sky-50 to-white py-24" data-aos="fade-up">
  <div class="max-w-7xl mx-auto px-6">
    ...
    <p class="text-gray-600 text-lg text-center mb-12">
      Berikut fitur yang terdapat pada aplikasi SIAPDOL (Sistem Pajak Daerah Online)
    </p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-12 items-start">
      ...
      <div class="md:col-span-2 flex flex-col space-y-6">
        <div
          v-for="(f, i) in fitur"
          :key="i"
          class="py-8 px-5 rounded-xl font-semibold leading-snug w-full text-left transition-transform hover:-translate-y-3 flex items-center justify-start h-28 bg-[#005787] text-white"
        >
      ...
      <div class="md:col-span-4 space-y-8">
        <div
          class="relative -mx-6 bg-green-50 py-2 flex justify-center items-center rounded-3xl transition-shadow duration-500"
        >
          <img
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 text-gray-500 text-left mt-2">
          <ul class="list-disc pl-6 space-y-2 text-lg leading-relaxed">
            <li>Cek Tagihan PBB</li>
            <li>Cetak SPPT</li>
            <li>Cetak Salinan SPPT</li>
          </ul>
  ...
  <div class="max-w-7xl mx-auto px-6 text-center">
    ...
    <div class="flex justify-center flex-wrap gap-8">
      <div
        ...
        :key="idx"
        class="w-[300px] md:w-[380px] rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition-transform duration-500 cursor-pointer"
...
const heroImage = new URL("@/assets/img/siapdol.png", import.meta.url).href;
