...
const products = [
  ...
  desc: "Menyediakan jalur komunikasi terpusat dan notifikasi otomatis antar sistem melalui API dan webhook real-time.",
  img: new URL("@/assets/icon/gateway.png", import.meta.url).href,
  link: "/api-gateway",
  },
  {
    title: "OAuth2 & Token Authentication",
    desc: "Menjamin akses aman antar sistem dengan autentikasi berbasis token dan standar OAuth2 yang terverifikasi.",
    img: new URL("@/assets/icon/gateway.png", import.meta.url).href,
    link: "/api-gateway",
  },
  {
    title: "Dokumentasi OpenAPI",
    desc: "Mempermudah pengembangan dan integrasi sistem melalui dokumentasi API yang terstruktur dan terbuka.",
    img: new URL("@/assets/icon/gateway.png", import.meta.url).href,
    link: "/api-gateway",
  }
];
